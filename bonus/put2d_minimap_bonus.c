...
/*   Updated: 2025/06/07 13:24:02 by topiana-         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	put2d_minimap(t_mlx *mlx, size_t side)
{
	...
	while (i < MAXPLAYERS)
	{
		...
		{
			// ft_printf("A\n");
			put2d_player(mlx, (float *)mlx->fake_lobby[i].pos, side, ((t_sprite *)mlx->fake_lobby[i].extra)->chroma);
		}
		i++;
	}
	...
	// ft_printf("A\n");
	// ft_printf("B\n");
	put2d_ray(mlx, side, 0, mlx->player.sprite->chroma);
	// ft_printf("C\n");
